...
namespace Realtors_Portal.Areas.Admin.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PropertyTypeID,TypeName,Description,IsActive")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PropertyTypeID,TypeName,Description,IsActive")] PropertyType propertyType)
        {
            if (ModelState.IsValid)
            {
